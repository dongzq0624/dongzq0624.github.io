...
describe('Validate TS configs', () => {
  it('Validate qcxn-eslint-config/typescript', async () => {
  ...
  it('Validate qcxn-eslint-config/typescript/vue', async () => {
  ...
  it('Validate qcxn-eslint-config/essential/typescript', async () => {
  ...
  it('Validate qcxn-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate qcxn-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate qcxn-eslint-config/typescript/node', async () => {
