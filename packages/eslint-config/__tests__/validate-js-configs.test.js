...
describe('Validate JS configs', () => {
  it('Validate qcxn-eslint-config', async () => {
  ...
  it('Validate qcxn-eslint-config/es5', async () => {
  ...
  it('Validate qcxn-eslint-config/vue', async () => {
  ...
  it('Validate qcxn-eslint-config/essential', async () => {
  ...
  it('Validate qcxn-eslint-config/essential/es5', async () => {
  ...
  it('Validate qcxn-eslint-config/essential/react', async () => {
  ...
  it('Validate qcxn-eslint-config/essential/vue', async () => {
  ...
  it('Validate qcxn-eslint-config/node', async () => {
